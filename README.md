...
- **[Work Tracker](https://github.com/KaganCubukcu/work-tracker)** - _(In Progress)_ A personal daily work-tracking dashboard built with .NET 10 Minimal API, Angular 22, and SQLite. Features a live work-session timer with break-aware net remaining time, todo management, timestamped daily logs, and a tenure badge — all in a dark ambient UI with IBM Plex typography.
